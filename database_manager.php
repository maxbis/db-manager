            ...
            <div id="dashboardContent" style="display: none;">
                ...
                <div class="database-list">
                    <div class="database-list-header">
                        ...
                        <button id="refreshDatabasesBtn" class="btn-secondary" style="padding: 6px 12px; font-size: 12px;">🔄 Refresh</button>
                    </div>
                    <div id="databaseList">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="newDatabaseName">Database Name: <span style="color: var(--color-danger);">*</span></label>
    ...
    <div class="modal" id="createTableModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="newTableColumns">Columns (one per line): <span style="color: var(--color-danger);">*</span></label>
                    <textarea id="newTableColumns" placeholder="id INT AUTO_INCREMENT PRIMARY KEY&#10;name VARCHAR(255) NOT NULL&#10;email VARCHAR(255) UNIQUE&#10;created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP" rows="8"></textarea>
                </div>
                <div class="form-group">
